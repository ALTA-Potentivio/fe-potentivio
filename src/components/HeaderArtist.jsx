              ...
              <div className="modal-content bg-white border-0">
                ...
                >
                  <a className="modal-title" id="targetModalLabel">
                    <img style={{ marginRight: "0.75rem" }} src="" alt="" />
                  </a>
                  <button
                    type="button"
                ...
                >
                  <ul className="navbar-nav responsive me-auto mt-2 mt-lg-0">
                    {location.pathname === "/artist/inbox-artist" ? (
                      <>
                        ...
                        <li className="nav-item active position-relative">
                          <a className="nav-link" href="/artist/inbox-artist">
                            Inbox
                          </a>
                        </li>
                      </>
                    ...
                    <li className="nav-item position-relative">
                      ...
                      <form
                        className="collapse position-absolute form center-search border-0"
                        id="collapse"
                      >
